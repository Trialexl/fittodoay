...
if [ ! -f ".env" ]; then
  ...
  echo "  edit .env: DOMAIN, PUBLIC_APP_URL, LETSENCRYPT_EMAIL, BACKEND_IMAGE, FRONTEND_IMAGE, NEXT_SERVER_ACTIONS_ENCRYPTION_KEY, DJANGO_ALLOWED_HOSTS, DJANGO_CORS_ALLOWED_ORIGINS, DJANGO_CSRF_TRUSTED_ORIGINS" >&2
  exit 1
fi
